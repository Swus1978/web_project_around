...
const handleEditProfile = (editProfileButton, editPopup, editForm, authorTitle, authorText, closeEditPopupButton) => {
...
const init = () => {
    ...
    handleEditProfile(editProfileButton, editPopup, editForm, authorTitle, authorText, closeEditPopupButton);
